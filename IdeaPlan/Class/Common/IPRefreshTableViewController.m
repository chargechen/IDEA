...
#import "LZRefreshTableViewController.h"

@interface LZRefreshTableViewController ()<EGORefreshTableHeaderDelegate>
@end

@implementation LZRefreshTableViewController
...
-(void)addRefreshControl
{
    ...
    [mTableView addSubview:_refreshTableViewHeaderView];
...
- (void)refreshWithAnimation
{
    ...
    [mTableView setContentOffset:CGPointMake(0, -RefreshViewHight)];
    [UIView commitAnimations];
    
    [_refreshTableViewHeaderView egoRefreshScrollViewDidScroll:mTableView];
}
...
{
    [_refreshTableViewHeaderView egoRefreshScrollViewDidEndDragging:mTableView];
}
