...
#import "IPPullingTableViewController.h"
#import "UINavigationBar+CustomImage.h"
//#import "IPPofileModel.h"
@interface IPPullingTableViewController ()

@end

@implementation IPPullingTableViewController
...
//    if (myInfo) {
//        IPPofileModel *profile = [[IPPofileModel alloc] init];
