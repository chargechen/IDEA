...
#import "AMUIUtility.h"
#import "PublicDefine.h"
#import "UIButton+Bootstrap.h"

@implementation AMUIUtility
...
+ (UIButton *)createBarBtn:(NSString *)title target:(id)target selector:(SEL)sel
{
	...
	CGFloat width = [AMUIUtility barBtnItemWidth:title];
    btn.frame = CGRectMake(0.0F, 0.0F, width, 32);
    btn.titleLabel.font = [UIFont systemFontOfSize:[AMUIUtility barBtnItemFontSize]];
    if(!isIOS7)
    {
        [btn defaultStyle];
    }
