...
-(void)primaryStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:255/255.0 green:119/255.0 blue:0/255.0 alpha:1];
    self.layer.borderColor = [[UIColor colorWithRed:235/255.0 green:90/255.0 blue:0/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:225/255.0 green:89/255.0 blue:0/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
